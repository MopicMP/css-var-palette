...
> CSS custom property color palette system

[![npm version](https://badge.fury.io/js/css-var-palette.svg)](https://www.npmjs.com/package/css-var-palette)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install css-var-palette
```

## Quick Start

```javascript
const { palette } = require('css-var-palette');
...
```javascript
const { palette, batch } = require('css-var-palette');
